...
def get_parser():
    ...
    parser.add_argument('--epochs', type=int, default=1500, help='Total epoch')
    ...
    parser.add_argument('--category', type=str, default='the class name', help='categories for each class')
